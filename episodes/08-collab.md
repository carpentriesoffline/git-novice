...
```bash
$ git clone http://carpentriesoffline.org:3000/vlad/planets.git ~/Desktop/vlad-planets
```
...
- `git remote set-url [name] [newurl]` changes the URL that is associated
  ...
  account, or from Gitea to a different hosting service, such as GitHub. Or, if we made a typo when
  adding it!
...
What are some of the benefits of using version control, Git and Gitea?
